...
jQuery(function() {
    ...
    jQuery(window).scroll(function() {
        ...
        if (scroll >= 300) {
            //alert(11);
            jQuery(".header2sdtr").addClass("hover");
            jQuery(".top_wrapper").addClass("addbgheader");
             jQuery(".header-right").addClass("menuppam");
              jQuery(".mnrt").addClass("rtsnds");

        } else {
             jQuery(".header2sdtr").removeClass("hover");
            jQuery(".top_wrapper").removeClass("addbgheader");
            jQuery(".logomain").removeClass("logo_sizessrts");
            jQuery(".header-right").removeClass("menuppam");
        }
    });
});
...
{
 .hover{position:fixed; top:0px; left:0px; right:0px; height: 68px;}
}

@media(max-width:768px)
{
    .padboth{padding-left:0px!important; padding-right:0px!important;}
 .hover{position:fixed; top:0px; left:0px; right:0px; min-height: 50px;}
}
